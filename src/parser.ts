...
export type TOPLEVEL = TOPLEVEL_1 | TOPLEVEL_2;
...
export type STATEMENT = LET_STATEMENT;
export interface LET_STATEMENT {
    kind: ASTKinds.LET_STATEMENT;
    name: IDENTIFIER;
    expr: EXPR;
}
...
export class Parser {
    ...
    public matchSTATEMENT($$dpth: number, $$cr?: ErrorTracker): Nullable<STATEMENT> {
        return this.matchLET_STATEMENT($$dpth + 1, $$cr);
    }
    public matchLET_STATEMENT($$dpth: number, $$cr?: ErrorTracker): Nullable<LET_STATEMENT> {
        return this.run<LET_STATEMENT>($$dpth,
            () => {
                let $scope$name: Nullable<IDENTIFIER>;
                let $scope$expr: Nullable<EXPR>;
                let $$res: Nullable<LET_STATEMENT> = null;
                if (true
                    && this.match_($$dpth + 1, $$cr) !== null
                    ...
                    $$res = {kind: ASTKinds.LET_STATEMENT, name: $scope$name, expr: $scope$expr};
                }
                return $$res;
            });
    }
    public matchEXPR($$dpth: number, $$cr?: ErrorTracker): Nullable<EXPR> {
        return this.run<EXPR>($$dpth,
            () => {
                let $scope$sum: Nullable<SUM>;
                let $$res: Nullable<EXPR> = null;
                if (true
                    && ($scope$sum = this.matchSUM($$dpth + 1, $$cr)) !== null
                ) {
                    $$res = {kind: ASTKinds.EXPR, sum: $scope$sum};
                }
                return $$res;
            });
    }
        ...
        return this.run<SUM>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && ($scope$t = this.matchSUM_$0($$dpth + 1, $$cr)) !== null
                ) {
                    $$res = {kind: ASTKinds.SUM, h: $scope$h, t: $scope$t};
                }
                return $$res;
            });
    }
        ...
        return this.run<FAC>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && ($scope$t = this.matchFAC_$0($$dpth + 1, $$cr)) !== null
                ) {
                    $$res = {kind: ASTKinds.FAC, h: $scope$h, t: $scope$t};
                }
                return $$res;
            });
    }
    public matchFAC_$0($$dpth: number, $$cr?: ErrorTracker): Nullable<FAC_$0> {
        return this.run<FAC_$0>($$dpth,
            () => {
                let $scope$op: Nullable<string>;
                let $scope$sm: Nullable<DOT>;
                let $$res: Nullable<FAC_$0> = null;
                if (true
                    && this.match_($$dpth + 1, $$cr) !== null
                    && ($scope$op = this.regexAccept(String.raw`(?:\*|/)`, "", $$dpth + 1, $$cr)) !== null
                    && this.match_($$dpth + 1, $$cr) !== null
                    && ($scope$sm = this.matchDOT($$dpth + 1, $$cr)) !== null
                ) {
    ...
    public matchDOT($$dpth: number, $$cr?: ErrorTracker): Nullable<DOT> {
        return this.run<DOT>($$dpth,
            () => {
                let $scope$h: Nullable<ATOM>;
                let $scope$t: Nullable<DOT_$0>;
                let $$res: Nullable<DOT> = null;
                if (true
                    && ($scope$h = this.matchATOM($$dpth + 1, $$cr)) !== null
                    && ($scope$t = this.matchDOT_$0($$dpth + 1, $$cr)) !== null
                ) {
                    $$res = {kind: ASTKinds.DOT, h: $scope$h, t: $scope$t};
                }
                return $$res;
            });
    }
        ...
        return this.run<DOT_$0>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.DOT_$0, op: $scope$op, sm: $scope$sm};
                }
                return $$res;
            });
    }
